...
const moveFile = async (
    ...
    if (isOverwrite) {
        if (overwriteBehavior === 'prompt' || overwriteBehavior === 'interactive') {
...
//A wrapper for the actual function, in case it needs to get called programmatically
const main = async (
    sourcePath,
    destDir,
    dryrun = false,
